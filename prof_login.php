...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submitlogin'])) {
    ...
    $sql = "SELECT id,password FROM profs WHERE email = '$emailValue'";
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        if (password_verify($passwordValue, $storedHashedPassword)) {
            ...
            $_SESSION["error"] = "";
            header("Location: prof_library.php"); // Redirect to the dashboard or another secured page
        } else {
...
<body class="bg-light">
    ...
    <section id="login" class="form-container" style="">
        ...
        <form action="" method="post" enctype="multipart/form-data">
           ...
           <input type="submit" value="Students Portal" onclick="ToStudent()" name="submit" class="btn signup">
        </form>
        <br><br><br><br>
     </section>
